<div class="flex flex-col w-full h-screen bg-indigo-900" x-data="{ showSubscribe: @entangle('showSubscribe'), showSuccess: @entangle('showSuccess') }">
    ...
    <div class="container flex items-center h-full mx-auto">
        <div class="flex flex-col items-start w-1/3">
            ...
            <p class="mb-10 text-xl text-indigo-200">We are just checking the <span
                ...
                subscribing?</p>
            <x-button class="px-8 py-3 bg-red-500 hover:bg-red-600" @click="showSubscribe = true">Subscribe
            </x-button>
        </div>
    </div>
